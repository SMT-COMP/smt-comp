...
let all_divisions = 
  ...
  List.iter (fun d -> Hashtbl.add t d () )
    [ "ABVFP"; "ALIA"; "AUFLIA"; "AUFLIRA"; "AUFNIRA"; "BV"; "LIA"; "LRA"; "NIA"; "NRA";
      "QF_ABV"; "QF_ALIA"; "QF_ANIA"; "QF_AUFBV"; "QF_AUFLIA"; "QF_AUFNIA";
      "QF_AX"; "QF_BV"; "QF_BVFP"; "QF_FP"; "QF_IDL"; "QF_LIA"; "QF_LIRA";
      "QF_LRA"; "QF_NIA"; "QF_NIRA"; "QF_NRA"; "QF_RDL"; "QF_UF"; "QF_UFBV";
      "QF_UFIDL"; "QF_UFLIA"; "QF_UFLRA"; "QF_UFNIA"; "QF_UFNRA"; "UF"; "UFBV";
