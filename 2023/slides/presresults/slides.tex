...
\myincludepdf{slides-YicesQS-2023.pdf}
...
\begin{frame}{Plans for SMT-COMP 2023}
  \begin{itemize}
    \item "Revelations are found in clouds” --- Serge King
    \item MV: Algebraic number non experimental
...
\begin{frame}[shrink=0.95]{Benchmark contributors}
  In 2023 \emph{new benchmarks} were contributed by:
