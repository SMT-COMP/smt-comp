...
$MAKE_DIVISION -d $DIVISIONS -y $YEAR --single_query $BENCHMARKS_SQ --incremental $BENCHMARKS_INC --model_validation $BENCHMARKS_MV --unsat_core $BENCHMARKS_UC --proof_exhibition $BENCHMARKS_PE --experimental $EXPERIMENTAL_CSV $OUTPUT_DIVISIONS
