...
%    \scalebox{.7}{
    {\tiny
    \begin{tabular}{ccccc}
        \includegraphics[scale=0.5,trim=0pt 0.60cm 0pt 0pt]{signature-blank-crop-jochen.pdf} &&
        \includegraphics[scale=0.25,trim=1.5cm 2.75cm 0pt 0pt]{signature_bobot.png} &&
        \includegraphics[trim=0pt 0.10cm 0pt 0pt]{MB-Signature.png} \\
    \cline{1-1} 
    \cline{3-3}
    \cline{5-5}
    \\ \
