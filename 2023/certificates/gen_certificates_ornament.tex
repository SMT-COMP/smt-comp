...
\newcommand{\MakeOnePage}[4]{
    ...
    \ifstrempty{#4}{}{
     \textcolor{red!30!black!90}  {\textit{Solver won logic \ifstrempty{#3}{}{(but not the corresponding division)}}}
...
%    \scalebox{.7}{
    {\tiny
    \begin{tabular}{ccccc}
        \includegraphics[scale=0.5]{signature-blank-crop-jochen.pdf} && && \includegraphics{MB-Signature.png} \\
    \cline{1-1} 
    \cline{3-3}
    \cline{5-5}
    \\ \
