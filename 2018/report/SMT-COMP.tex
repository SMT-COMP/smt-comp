...
\newcommand{\nc}[1]{{[}#1{]}}
\newcommand{\cc}{\cellcolor{white}}
\newcommand{\rc}{\rowcolor{white}}
\newcommand{\drc}{\rowcolor[gray]{.9}}
\newcommand{\dcc}{\cellcolor[gray]{.9}}
...
case, its name appears just once.  A division is \emph{competitive} if
