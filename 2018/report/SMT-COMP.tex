...
highest-ranked solver for each division from 2015--2018.
Non-competitive divisions use gray font.
...
solver performance, no cell color indicate that the best sequential solver
...
divisions; we are including all divisions here.  Moreover, we are
...
\begin{figure}
  ...
  \scalebox{.45}{\includegraphics{%
        plot/pdf/cactus_plot-Virtual_Best_Solver_(VBS)_2015-2018.pdf}}
