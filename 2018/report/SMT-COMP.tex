...
\begin{itemize}[noitemsep]
  \item \makebox[5em][l]{$e\geq 0$} number of erroneous results (usually~$e = 0$)
...
the current problems.  The fact that industrial-strength solvers
...
solvers according to the competition-wide ranking for 2015--2018.
Also shown is Z3, which ranked in high position each year but was
running hors concours.  Sequential and parallel performance are
reported separately.
%
