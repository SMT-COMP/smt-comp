...
job pairs in~2018.  (This is the number of unique solver/benchmark
...
in the solver will be triggered is below~$20\,\%$.
...
increased from 2014 to 2015 by 0.1\%, from 2016 to 2017 by 3.9\%, and
from 2017 to 2018 by 0.3\%.  Interestingly, it decreased from 2015 to
2016 by 3.5\%.  This is mainly due to the fact that, in 2015, more
than \num{5600} benchmarks of division QF\_FP were solved by one of
the two participating configurations of Z3 but by no other solver, and
in~2016 Z3 did not participate in this division.
...
2015, already 99.95\% of the eligible queries were answered correctly,
which naturally does not leave a lot of room for improvement.  In
2016, performance decreased by \num{185625} correct answers (0.61\%),
which can be entirely attributed to a performance regression of Z3 on
two benchmarks in the QF\_NIA division.
