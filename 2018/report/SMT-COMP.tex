...
solvers.  Selected results are presented
%TODO: and analyzed
in Section~\ref{sec:results}.  We conclude with suggestions for future
...
ranked behind solvers that did not); second, on the number of correct
...
description of the scoring regulations can be found in the competition
rules~\cite{rules18}.
...
\TODO: non-competitive divisions
