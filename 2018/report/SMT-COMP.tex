...
\begin{abstract}
  ...
  annual competition between Satisfiability Modulo Theories solvers.
  We report on the design and selected results of the competition
  during the last FLoC Olympiad, from 2015 to 2018. \TODO: some
  notable observations/conclusions?
\end{abstract}
...
typically motivated by application areas, include the theory of
arrays, integer and real arithmetic, bit-vectors, and floating-point
numbers among others.  For instance, the following is an SMT formula
over the combination of integer arithmetic and uninterpreted
functions:
$$TODO$$
...
Conference (FLoC) Olympic Games in~2014, and again in~2018.  It was
last described in a 2014 competition report~\cite{TODO}.  In this
paper, we report on the design and selected results of the competition
