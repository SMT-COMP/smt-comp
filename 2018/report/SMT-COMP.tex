...
\begin{figure}
  \begin{subfigure}[t]{0.5\textwidth}
    \scalebox{.35}{\includegraphics{plot/pdf/cactus_plot-Virtual_Best_Solver_(VBS)_2014-2015.pdf}}
    \caption{2014 vs.~2015}
  \end{subfigure}
  \begin{subfigure}[t]{0.5\textwidth}
    \scalebox{.35}{\includegraphics{plot/pdf/cactus_plot-Virtual_Best_Solver_(VBS)_2015-2016.pdf}}
    \caption{2015 vs.~2016}
  \end{subfigure}
  \\[4ex]
  \begin{subfigure}[t]{0.5\textwidth}
    \scalebox{.35}{\includegraphics{plot/pdf/cactus_plot-Virtual_Best_Solver_(VBS)_2016-2017.pdf}}
    \caption{2016 vs.~2017}
  \end{subfigure}
  \begin{subfigure}[t]{0.5\textwidth}
    \scalebox{.35}{\includegraphics{plot/pdf/cactus_plot-Virtual_Best_Solver_(VBS)_2017-2018.pdf}}
