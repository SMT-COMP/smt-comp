...
UNSAT_CORE_2016="../../../2016/csv/Unsat_Core_Track.csv"
UNSAT_CORE_2017="../../../2017/csv/Unsat_Core_Track.csv"
UNSAT_CORE_2018="../../../2018/csv/Unsat_Core_Track.csv"
...
UC_2016="2016_Unsat_Core_Track.csv"
UC_2017="2017_Unsat_Core_Track.csv"
UC_2018="2018_Unsat_Core_Track.csv"
...
# strip column header line of unsat core track files and extract relevant
# columns (columns for 2016-2018 do not match):
# pair id,benchmark,benchmark id,solver,solver id,status,result,result-is-erroneous,reduction
tail -n +2 "$UNSAT_CORE_2016" |
  awk -F , '{print $1","$2","$3","$4","$5","$8","$12","$19","$26}' > "$UC_2016"
tail -n +2 "$UNSAT_CORE_2017" |
  awk -F , '{print $1","$2","$3","$4","$5","$8","$12","$20","$27}' > "$UC_2017"
tail -n +2 "$UNSAT_CORE_2018" |
  awk -F , '{print $1","$2","$3","$4","$5","$8","$12","$25","$31}' > "$UC_2018"


# delete track name column for unsat core track files
sed -i -e 's:,Competition Unsat-Core Track/:,:' "$UC_2016"
sed -i -e 's:,Competition - Unsat-Core Track/:,:' "$UC_2017"
sed -i -e 's:,Competition - Unsat-Core Track/:,:' "$UC_2018"
...
./common-benchmarks.sh "$UC_2016" "$UC_2017" > Unsat_Core_Track_Common_Benchmarks_2016_2017.csv
./common-benchmarks.sh "$UC_2017" "$UC_2018" > Unsat_Core_Track_Common_Benchmarks_2017_2018.csv
./common-benchmarks.sh "$UC_2016" "$UC_2017" "$UC_2018" > Unsat_Core_Track_Common_Benchmarks_2016_2017_2018.csv
...
./unsound-solvers-uc.sh "$UC_2016" > Unsat_Core_Track_Unsound_Solvers_2016.csv
./unsound-solvers-uc.sh "$UC_2017" > Unsat_Core_Track_Unsound_Solvers_2017.csv
./unsound-solvers-uc.sh "$UC_2018" > Unsat_Core_Track_Unsound_Solvers_2018.csv
...
./remove-unsound-solvers.sh Unsat_Core_Track_Unsound_Solvers_2016.csv "$UC_2016" > 2016_Unsat_Core_Track.sound.csv
./remove-unsound-solvers.sh Unsat_Core_Track_Unsound_Solvers_2017.csv "$UC_2017" > 2017_Unsat_Core_Track.sound.csv
./remove-unsound-solvers.sh Unsat_Core_Track_Unsound_Solvers_2018.csv "$UC_2018" > 2018_Unsat_Core_Track.sound.csv
...
./virtual-best-solver-uc.sh 2016_Unsat_Core_Track.sound.csv > 2016_Unsat_Core_Track.vbs.csv
./virtual-best-solver-uc.sh 2017_Unsat_Core_Track.sound.csv > 2017_Unsat_Core_Track.vbs.csv
./virtual-best-solver-uc.sh 2018_Unsat_Core_Track.sound.csv > 2018_Unsat_Core_Track.vbs.csv
