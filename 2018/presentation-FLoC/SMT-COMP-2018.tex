...
\begin{frame}{Unsat-Core Track}
  ...
  \begin{tikzpicture}
    ...
    \node at (-4,-.6) {\includegraphics[width=1cm]{floc-medal}};    
  \end{tikzpicture}
\end{frame}
...
\begin{frame}{Main Track}
  ...
  \begin{tikzpicture}
    ...
    \node at (3.85,0) {\includegraphics[width=1cm]{floc-medal}};
    \node at (5.3,2.85) {\includegraphics[width=1cm]{floc-medal}};
  \end{tikzpicture}
...
\begin{frame}{Main Track: Competition-Wide Scoring}
  ...
  \uncover<6->{\begin{tikzpicture}
    ...
    \node at (-.8,1.2) {\includegraphics[width=1cm]{floc-medal}};
    \node at (-1.4,0) {\includegraphics[width=1cm]{floc-medal}};
    \node at (-.2,0) {\includegraphics[width=1cm]{floc-medal}};
  \end{tikzpicture}}
