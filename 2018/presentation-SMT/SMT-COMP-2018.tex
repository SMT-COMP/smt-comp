...
\begin{frame}{Unsat-Core Track}
  ...
  \only<2>{\begin{center}
    \begin{tabular}{lp{.7\textwidth}}
    Solver      & Divisions won \\ \hline \\[-1.5ex]
    CVC4        & QF\_AUFLIA, QF\_IDL, QF\_LIRA$^\text{par}$, QF\_RDL, QF\_UF \\
    \\[-1.5ex]
    SMTInterpol & \\
    \\[-1.5ex]
    Yices-2.6.0 & \\
  ...
  \only<4>{\begin{center}
    ...
    SMTInterpol & QF\_LIA, QF\_LRA, QF\_UFLIA \\
    \\[-1.5ex]
    Yices-2.6.0 & QF\_ABV, QF\_ALIA, QF\_AUFBV, QF\_AX, QF\_BV, QF\_LIRA$^\text{seq}$, QF\_UFBV, QF\_UFIDL, QF\_UFLRA
    \end{tabular}
  \end{center}}
\end{frame}
