...
set output 'smtlib2-file-count-by-size.png'
...
set logscale y
set ytics ("1" 1, "10" 10, "100" 100, "1000" 1000, "10000" 10000, "100000" 100000) font ", 20"
set boxwidth 0.25
set style fill solid 1.0 noborder
set xlabel "File size (in bytes)."
plot "smtlib2-file-count-by-size.dat" w boxes lc rgb "#CCCCCC" t 'Number of benchmarks'
