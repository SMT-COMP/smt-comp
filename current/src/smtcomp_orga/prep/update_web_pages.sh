...
smtcomp-orga-extract_data_from_solvers_divisions.py -d $LOGICS solvers_divisions_all.csv ../../../smt-comp.github.io/_participants_$YEAR $YEAR
smtcomp-orga-make_participants_md.py -d $DIVISIONS -y $YEAR -n "$NYSE_DATE;$NYSE_VALUE" ../../../smt-comp.github.io/$YEAR/
