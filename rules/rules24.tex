...
\item[June~8] Deadline for final versions of solvers, including
  system descriptions.
\item[June~11] Opening value of NYSE Composite Index used to compute
...
\begin{itemize}
  ...
  The single query, incremental, unsat-core, model-validation and proof exhibition tracks 
  will no longer run on the StarExec platform hosted by the University of Iowa.
...
%
  ...
  The memory limits for the single query, incremental, unsat-core, model-validation and proof exhibition tracks are reduced to 30\,GB.
%
...
as a post-processor
to validate and accumulate the results.
\todo{We need a new link for the corresponding benchexec script.}
