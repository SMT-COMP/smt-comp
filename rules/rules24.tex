...
\begin{itemize}
  \item {\bf Submission process.}  \emergencystretch.5cm \todo{Details}.
%
  \rationale{\todo{Details}}
  
  \item {\bf Move from StarExec to BenchExec.}  \emergencystretch.5cm \todo{Details}
%
  \rationale{\todo{Details}}
\end{itemize}
...
\todo{Is there a way for the users to run tests directly on the SoSy-Lab BenchExec cluster?}
%
%
