...
refuted if the number of checking solvers whose result is \textt{sat}
exceeds the number of checking solvers whose result is \textt{unsat},
or if the unsat-core producing solver is used as a checking solver and
its result is \textt{sat}.  The time limit for checking unsatisfiable
