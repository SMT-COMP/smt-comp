...
\item[June 1] First versions of solver competitors are due to the organizers, including divisions being entered.
  Versions of the benchmark scrambler, benchmark selector and trace executor made available.
\item[June 8] Final version of the benchmark scrambler, benchmark selector and trace executor made available.
\item[June 8] Benchmark libraries are frozen.
\item[June 15] Final versions of solvers due via StarExec (for
  all tracks), including divisions being entered, system
  descriptions and magic numbers for benchmark scrambling.
\item[June 16] Opening value of NYSE Composite Index used to complete random seed.
