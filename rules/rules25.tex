...
\title{20th International Satisfiability Modulo Theories Competition
  (SMT-COMP 2025): Rules and Procedures}
...
ETH Z\"{u}rich\\
Switzerland\\
{\small\href{mailto:dominik.winterer@inf.ethz.ch}{\texttt{dominik.winterer@inf.ethz.ch}}}
}
...
\item \href{https://daviddeharbe.github.io}{David D\'{e}harbe}~-- \href{https://clearsy.com}{CLEARSY}, France
\item \href{https://www.muni.cz/en/people/359542-martin-jonas}{Martin Jon\'{a}\v{s}}~-- Masaryk University, Czechia (chair)
\item \href{https://wintered.github.io/}{Dominik Winterer}~-- ETH Zurich, Switzerland
\end{itemize}
%
...
%
David D\'{e}harbe was part of the developing team of the SMT solver veriT~\cite{verit}.
%
Martin Jon\'{a}\v{s} is part of the developing team of the SMT solver Q3B~\cite{Q3B} and was a member of the developing team of the SMT solver MathSAT5~\cite{MathSAT5}. Dominik Winterer has been conducting large-scale testing campaigns for discovering and preventing unsoundness issues in SMT solvers. 
