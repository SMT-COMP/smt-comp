...
%
  \rationale{The presence of the base tool in the contest provides the best way to
...
\begin{itemize}
  \item \textbf{smtcomp.} This tool combines the functionality of most of the
    ...
    \begin{itemize}
      ...
      \item \textbf{Post-processing.} The tool has commands that process and
        summarize all the results from files generated by BenchExec.
      \item \textbf{Scoring.} The tool has a command that executes the scoring computation
