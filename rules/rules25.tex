...
Submitters of a derived tool should also submit the corresponding base tool for the
same track and logics as their derived tool.
...
\begin{center}
  \small
  \texttt{registry.gitlab.com/sosy-lab/benchmarking/competition-scripts/user:latest}
\end{center}
