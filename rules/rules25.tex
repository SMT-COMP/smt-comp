...
\begin{itemize}
  ...
  also submit the corresponding base tool for the same track and logics.\dd{To be review}
%
  ...
  \item {\bf Unsat cores.} \emergencystretch.5cm \dd{to be completed}
%
  \rationale{...}

  \item {\bf Time limits.} \em
  Transcript written on rules25.log.
  \rationale{...}
...
It will be executed on a computer that have the same installation than the docker image \texttt{registry.gitlab.com/sosy-lab/benchmarking/competition-scripts/user:latest}.
