...
\item {\bf Derived solver scoring \& recognition.} \emergencystretch.5cm A
  ...
  Moreover, derived solvers are excluded from competition-wide recognitions. \\
...
winning only if it achieves \emph{at least a $10\,\%$ improvement on the PAR-2
  score over its base solver}. Derived solvers are additionally excluded from
the biggest lead, largest contribution, and best overall ranking, regardless
their scores.
