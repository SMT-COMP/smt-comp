...
(\url{http://smt-workshop.cs.uiowa.edu/2025/}),
which is affiliated with SAT~2025 (\url{https://satisfiability.org/SAT25/}).
...
%
  ...
  suitable infrastructure, Cloud track is not taking place for SMT-COMP 2025.
...
Submitters of a derived tool should also submit the corresponding base tool's binary 
for the same track and logics as their derived tool.
...
\begin{center}
  \url{https://smt-comp.github.io/2025/solver_submission/}
\end{center}
...
up to SMT 2025.  Intermediate results will be regularly posted to the
...
\url{https://smt-comp.github.io/2025/parallel-track.html}.
...
library.  The \maintrack and \paralleltrack{} will use a
...
The deadline for submission of new benchmarks is {\bf April~12, 2025}.
%
The organizers, in collaboration with the SMT-LIB maintainers, will be
checking and curating these until {\bf April~30, 2025}.
