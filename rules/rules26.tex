...
SoSy-Lab BenchExec cluster (for more details see \url{https://vcloud.sosy-lab.org/cpachecker/webclient/master/info}) and on a 256-processor, 2TB RAM machine for the Parallel Track.
