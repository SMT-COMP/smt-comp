...
%
    \rationale{Due to limitations of starexec, the standard error channel
      and standard output channel are not separated.  In the previous year, the
...
%    years,  we hope for a high number of participants in this track.  }
  ...
  \item {\bf The Strings Division is not experimental.}
    The last years competition introduced a experimental divisions for benchmarks that
