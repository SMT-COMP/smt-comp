...
\todo{time limit}
The \challenge Track will include both incremental and single query benchmarks and it will follow the same rules as the \incremental and  \main Track, respectively with two exceptions: benchmark selection and the time limit. The track will run on challenging industrial benchmarks provided by the community.
...
\header{\main and \challenge Track: Removal of Disagreements.}
%
\todo{do we need to update this notion?}
Before division scores are computed for the \main and \challenge tracks,
...
\header{\incremental Track: Removal of Disagreements.}
\todo{}

\header{\challenge Track: Removal of Disagreements.}
\todo{}
