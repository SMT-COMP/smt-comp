...
\header{Post-Processor.}
This track uses the post-processor at \rem{link tba} to accumulate the results.
...
\header{Post-Processor.}
This track uses the post-processors from the \maintrack (for non-incremental
...
\item \emph{Remove easy benchmarks.} The competition organizers will
    remove all benchmarks that were solved by all solvers (including the
        non-competitive solvers) in less than one second in the 2018 SMT
        competition.
