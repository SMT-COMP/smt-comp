...
SMT-COMP 2019 will have five tracks: the single problem track (formerly
known as main track), the incremental track (formerly known as application
track), the unsat-core track, the (new) industry challenge track, and the
(new) model validation track.
