...
\begin{center}
  \url{https://docs.google.com/forms/d/1gJ_9ztIzwsgeyR0R4H_yIg5lBxxxDBwSy8ZodXt5xKk}
\end{center}
...
The tool will output VALID for full satisfying models, and INVALID for partial models,
malformed models, models that do not satisfy the benchmark or if the solver returns
\texttt{unsat}. If the solver provides no output or returns \texttt{unknown} the model
validating tool will output UNKNOWN.
