...
competition web site, \url{www.smtcomp.org}.
...
validation?}.\footnote{\an{TODO: Is this obsolete?} The time limit may be
...
\header{Benchmark demographics. \rem{TODO: update}}
%
...
\rem{TODO: 24s, sat, unsat score description}
...
to assess sequential performance.  For incremental track divisions,
division scores will be based on raw scores only.\footnote{Since
  ...
  useful sequential score for the incremental track would require
