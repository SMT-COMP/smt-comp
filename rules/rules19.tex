...
\todo{add information about how benchmarks are selected for the \mvaltrack,
\challtrack, \ucoretrack, and the 24s, sat and unsat scores}
\begin{enumerate}
...
\todo{add information about how benchmarks are selected for the \mvaltrack,
\challtrack, \ucoretrack, and the 24s, sat and unsat scores -- either here
or below}
