...
\begin{itemize}
  ...
  \item {\bf Benchmark Selection.} Since 2015, the competition evaluated all
    ...
    competition.  In the Main track of last year's competition, 78\% of the 258,741
    benchmarks were solved by all supported solvers within the time
...
%
The competition will use a large subset of SMT-LIB benchmarks.  In all
tracks the following process will be used for culling the benchmark
pool.
\begin{enumerate}
