...
\header{Input and output. \todo{update}}
%
...
pair in the single problem, incremental and unsat core tracks, \todo{XX}~minutes in the industry challenge track, and \todo{XX}~minutes in the
model validation track \todo{Need to elaborate how time is split? Do we
...
\todo{Update accordingly: Do we run only up to the first unknown status
...
\header{Benchmark selection. \todo{update}}
%
