...
\item[June~2] Deadline for final versions of solvers, including
  system descriptions.
\item[\todo{TODO}] Opening value of NYSE Composite Index used to complete
...
SMT-COMP 2019 will have four tracks: the single problem track (formerly
known as main track), the incremental track (formerly known as application
track), the unsat-core track, and the (new) industry challenge track.
